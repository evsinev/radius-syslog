 ...
 *
 * Version:	$Id: rlm_detail.c,v 1.37.2.1.2.2 2006/07/05 17:08:31 aland Exp $
 *
...
static const char rcsid[] = "$Id: rlm_detail.c,v 1.37.2.1.2.2 2006/07/05 17:08:31 aland Exp $";
